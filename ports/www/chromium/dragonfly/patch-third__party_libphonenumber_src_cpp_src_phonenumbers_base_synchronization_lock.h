--- third_party/libphonenumber/src/cpp/src/phonenumbers/base/synchronization/lock.h.orig	2026-09-09 12:00:00 UTC
...
+#elif defined(__linux__) || defined(__APPLE__) || defined(__OpenBSD__) || defined(__FreeBSD__) || defined(__DragonFly__) || defined(I18N_PHONENUMBERS_HAVE_POSIX_THREAD)
