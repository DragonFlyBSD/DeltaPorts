...
index 64406690c8c4..1a9e3989372c 100644
...
@@ -141,9 +141,9 @@ int GetFlagsForMemoryPermission(OS::MemoryPermission access,
...
+#endif  // !V8_OS_AIX && !V8_OS_FREEBSD && !V8_OS_QNX && !V8_OS_DRAGONFLYBSD
     ...
     flags |= MAP_LAZY;
 #endif  // V8_OS_QNX
@@ -1354,7 +1354,7 @@ void Thread::SetThreadLocal(LocalStorageKey key, void* value) {
